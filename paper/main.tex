...
\begin{figure*}[t]
  ...
  \caption{Qualitative generation samples on six validation clips. Columns show ground truth, diagonal-decoding baseline, and frame-level speculative decoding. The speculative frames preserve scene structure and camera viewpoint, with a small quality loss consistent with the measured $1.5$ dB PSNR gap.}
  \label{fig:samples}
\end{figure*}
